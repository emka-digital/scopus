...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Nov 2020 pada 08.50
...
INSERT INTO `tbl_member` (`id`, `nama`, `alamat`, `gender`, `no_hp`, `email`, `password`, `role_id`, `user_active`, `date_created`, `foto`) VALUES
...
(5, 'Calender', 'member/kalender', 'nav-icon fas fa-fw fa-calendar-alt'),
(6, 'Mailbox', 'member/email', 'nav-icon far fa-fw fa-envelope'),
...
(9, 'E-Certificate', 'member/certificate', 'nav-icon fas fa-fw fa-file-alt'),
(10, 'Logout', 'member/login/logout', 'nav-icon fas fa-fw fa-sign-out-alt');
